...
"stage": {
    ...
    content: {
            ...
            },
            {
                ...
                fill: ["rgba(0,0,0,0)",'https://raw.githubusercontent.com/DeathBarmaglot/monolit/master/270_2123.jpg','0px','0px']
            },
            {
                id: 't4',
                type: 'image',
            ...
            },
            {
                id: 'Text3',
                type: 'text',
                rect: ['-230px', '46px','712px','186px','auto', 'auto'],
                text: "– 30%",
                align: "left",
                font: ['Arial Black, Gadget, sans-serif', 40, "rgba(248,248,248,1.00)", "400", "none", "normal"],
                transform: [[],['-90']]
            },
            {
                id: 'Text',
                type: 'text',
                rect: ['-77px', '201px','402px','186px','auto', 'auto'],
                text: "до ",
                align: "left",
                font: ['\'Arial Black\', Gadget, sans-serif', 20, "rgba(248,248,248,1)", "400", "none", "normal"],
                transform: [[],['-90']]
            },
            {
                id: '_270_212',
